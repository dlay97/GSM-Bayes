...
nSamples = 2 # Total number of emulation dataset samples
...
# Check number of folders in our emulation data directory
# If the number of folders == our requested number of samples, we already have
# the correct data to build our emulator from the summary files.
# Otherwise, we run the calculations and overwrite any previous calculations.
if count_directories(emulatorDir) != nSamples or not os.path.isfile(os.path.join(emulatorDir,'summary_model_vals.csv')):
